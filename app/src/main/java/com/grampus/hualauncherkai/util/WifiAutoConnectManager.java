...
public class WifiAutoConnectManager {
    ...
    public void connectWifi(String SSID, String Password) {
        ...
        WifiAutoConnectManager.WifiCipherType type = WifiAutoConnectManager.getCipherType(SSID);
        WifiConfiguration wifiConfig = mWifiAutoConnectManager.createWifiInfo(SSID, Password, type);
        if (wifiConfig == null) {
            Log.d("EMMwifi", SSID+"|wifiConfig is null!");
            return;
        }
        ...
        Log.d("EMMwifi", SSID+"|enabled "+enabled);
    }
